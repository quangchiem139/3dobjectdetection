...
main (int argc, char** argv)
{
  ...
  pcl::PointCloud<pcl::Narf36> feature_points;
  narf_descriptor.compute(feature_points);
  cout << "Extracted " << feature_points.size() << " descriptors for " << keypoint_indices.points.size() << " keypoints.\n";
